      ...
      <div>
        <Form>
          <div class="grid grid-cols-2 gap-4">
            ...
            <Field name="templateRepoFullName">
              {(field, props) => {
                return (
                  <SelectInput
                    {...props}
