...
export function deletePackageJson(
  client: Executor,
  args: DeletePackageJsonArgs,
): Promise<DeletePackageJsonReturns> {
...
export function getPackageJson(
  client: Executor,
  args: GetPackageJsonArgs,
): Promise<GetPackageJsonReturns> {
...
export function getRepositories(
  client: Executor,
): Promise<GetRepositoriesReturns> {
  return client.query(`\
select Repository { **
};
...
export function getTemplateRepositories(
  client: Executor,
): Promise<GetTemplateRepositoriesReturns> {
  return client.query(`\
select Repository { **
} filter (  
 .is_template = true
...
export function insertOrUpdateRepository(
  client: Executor,
  args: InsertOrUpdateRepositoryArgs,
): Promise<InsertOrUpdateRepositoryReturns> {
  return client.querySingle(
    `\
...
export function getDependenciesForRepo(
  client: Executor,
  args: GetDependenciesForRepoArgs,
): Promise<GetDependenciesForRepoReturns> {
  return client.query(
    `\
...
): Promise<DeleteRepositoryReturns> {
  return client.query(
    `\
...
export function getFilePath(
  client: Executor,
  args: GetFilePathArgs,
): Promise<GetFilePathReturns> {
  return client.querySingle(
    `\
...
export function getAllPackageJsons(
  client: Executor,
): Promise<GetAllPackageJsonsReturns> {
  return client.query(`\
